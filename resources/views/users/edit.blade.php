                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data" id="editUserForm">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                       id="name" name="name" value="{{ old('name', $user->name) }}" required autocomplete="off">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('username') is-invalid @enderror"
                                       id="username" name="username" value="{{ old('username', $user->username) }}" required autocomplete="off">
                                <small class="form-text text-muted">
                                    <i class="fas fa-info-circle me-1"></i>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                       id="email" name="email" value="{{ old('email', $user->email) }}" required autocomplete="off">
                                <small class="form-text text-muted">
                                    <i class="fas fa-info-circle me-1"></i>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                       id="phone" name="phone" value="{{ old('phone', $user->phone) }}" autocomplete="off">
                                <small class="form-text text-muted">
                                    <i class="fas fa-info-circle me-1"></i>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror"
                                      id="address" name="address" rows="3" placeholder="Alamat lengkap user">{{ old('address', $user->address) }}</textarea>
                            <small class="form-text text-muted">
                                <i class="fas fa-info-circle me-1"></i>
                        ...
                        <div class="mb-4">
                                ...
                                <div class="mb-3 text-center">
                                    <div class="border rounded p-3 bg-light d-inline-block">
                                        <img src="{{ Storage::url($user->profile_photo_path) }}"
                                             alt="Current Profile Photo" class="img-thumbnail rounded" style="max-width: 200px; height: auto;">
                                        <p class="text-muted small mt-2 mb-0">Foto profil saat ini</p>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div id="newPhotoPreview" class="mb-3 text-center" style="display: none;">
                                <div class="border rounded p-3 bg-light">
                                    <img id="previewImage" src="" alt="Preview Foto Baru" class="img-thumbnail rounded" style="max-width: 200px; height: auto;">
                        ...
                        <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="confirmData">
                                    Saya mengkonfirmasi bahwa data yang diubah sudah benar
                                </label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><i class="fas fa-check text-success me-2"></i>Username dan email harus unik</li>
                                <li><i class="fas fa-check text-success me-2"></i>Password kosong = tidak mengubah password</li>
                                <li><i class="fas fa-check text-success me-2"></i>Foto kosong = tidak mengubah foto</li>
                                <li><i class="fas fa-check text-success me-2"></i>Role dapat diubah sesuai kebutuhan</li>
                                <li><i class="fas fa-check text-success me-2"></i>Status aktif/nonaktif dapat diubah</li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <h6 class="text-warning">Perhatian:</h6>
                            <ul class="list-unstyled">
                                <li><i class="fas fa-exclamation-triangle text-warning me-2"></i>Pastikan data yang diubah sudah benar</li>
                                <li><i class="fas fa-exclamation-triangle text-warning me-2"></i>Perubahan akan langsung tersimpan ke database</li>
                                <li><i class="fas fa-exclamation-triangle text-warning me-2"></i>Password tidak dapat dilihat setelah disimpan</li>
                                <li><i class="fas fa-exclamation-triangle text-warning me-2"></i>Foto lama akan diganti dengan foto baru</li>
                            </ul>
                        </div>
                    </div>
                </div>
